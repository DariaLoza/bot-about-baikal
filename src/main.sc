...
theme: /
    ...
    state: Start
        ...
        a: Привет! Я могу расказать тебе о Байкале много всего интересного, например, о майнинге или о костеломах😊 Я только учусь, но уже знаю о нейтрино, медведях, Иркутской ГЭС и многом дургом.Задавай мне вопросы, а попробую на них ответить 😊
