...
theme: /
    ...
    state: Help
        q!: $regex</help>
        a: Я - специально обученный бот-путеводитель по выставке "Байкал для каждого". Выставка проходит в Design District, на 2-ом этаже. Некоторые фотографии обозначены цифрами: напиши число заинтересовавшего тебя снимка в строку сообщения, и я расскажу о нём подробнее.А может быть тебя заинтересуют следующие темы? Костоломы, национальная кухня, ГЭС, медведи, нейтрино, майнинг - выбирай любую, вводи ее в стору сообщения и я с удовольствием расскажу тебе, что знаю сам 😉
